...
public class SolaceIntegrationTest extends AbstractPubSubPlusTestCase {
        ...
        try {
            ...
            XMLMessageProducer prod = session.getMessageProducer(new JCSMPStreamingPublishCorrelatingEventHandler() {
                ...
                @Override public void responseReceivedEx(Object o) {
                    LOGGER.info("Producer received response for msg ex: " + o);
                }

                @Override public void handleErrorEx(Object o, JCSMPException e, long timestamp) {
                    LOGGER.info(
                        String.format("Producer received error for msg ex: %s@%s - %s%n", o, timestamp, e));
                }
    ...
    @Test
    public void sempRESTCall() throws IOException {
        ...
        Assertions.assertTrue(msgVpns.contains("default"));
